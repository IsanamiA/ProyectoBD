...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $newNoUnidades = $_POST['new_no_unidades'];
    $newMateria = $_POST['new_materia'];

    $sql = "UPDATE unidades SET noUnidades='$newNoUnidades', materia='$newMateria' WHERE id=$id";
...
<body>
    ...
    <form method="post" action="">
        Número de Unidades: <input type="text" name="new_no_unidades" value="<?php echo $row['noUnidades']; ?>"><br>
